class DasbordView {
  ...
  genereteLineGrafic() {
    const data = new GraficsGeneretor(tempData);
...
const tempData = [
  { year: 2023, month: 1, tipo: 'Incendio', contador: 1 },
  { year: 2023, month: 2, tipo: 'Roubo', contador: 4 },
  { year: 2023, month: 3, tipo: 'Intrusão', contador: 4 },
  { year: 2023, month: 7, tipo: 'Furto', contador: 2 },
  { year: 2023, month: 8, tipo: 'Intrusão', contador: 1 },
  { year: 2023, month: 9, tipo: 'Assalto', contador: 2 },
  { year: 2023, month: 11, tipo: 'Roubo', contador: 2 },
  { year: 2023, month: 12, tipo: 'Vandalismo', contador: 3 },
  { year: 2023, month: 1, tipo: 'Assalto', contador: 1 },
  { year: 2023, month: 2, tipo: 'Vandalismo', contador: 1 },
  { year: 2023, month: 3, tipo: 'Furto', contador: 1 },
];
